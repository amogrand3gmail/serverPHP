...
<div class="navbar">
  ...
  <a href="bemvindo.php?escolha=log">Logs</a>
  <a href="bemvindo.php?escolha=test">test</a>
</div>
...
<footer>
  ...
  <h2>
    ...
    <select name="idioma" id="idioma">
      <option value="Brasil">Portugues BR</option>
      <option value="USA">English US</option>
      <option value="Franca">Français</option>
      <option value="Japao">Japonês</option>
    </select>
    - Copyright 2025
  </h2>
</footer>
